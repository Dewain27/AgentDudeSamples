...
| | |
| --- | --- |
| **RFP reference** | RFP-2026-MANA184 |
| **Submitted** | October 27, 2026 |
| **Vendor** | Aventra Software Group |
| **Contact** | proposals@aventrasoftware.example · (512) 555-0182 |
| **Proposed fee** | $300,000 (fixed price) |
...
Thank you for the opportunity to respond to RFP-2026-MANA184 for
**Application Managed Services**. Aventra Software Group has designed, built, and operated custom software for mid-market and enterprise organizations since 2009, delivering more than 300 engagements across healthcare, government, education, financial services, and manufacturing. We specialize in modernizing legacy systems, unifying fragmented data, and shipping applications that teams adopt without a fight.

We have structured this proposal to address each of your requirements directly.
The fixed price quoted is **$300,000**, within your stated budget.
...
Aventra Software Group proposes to deliver **Application Managed Services** for Riverside Health Partners
— ongoing operation, support, monitoring, and enhancement of an existing application under a defined service-level agreement. We will deliver in **12 months**
for a **fixed fee of $300,000**, meeting your **SOC 2, ISO/IEC 27001**
requirements.

## 3. Understanding of your needs

You have software that needs to stay reliable, secure, and improving, but you don't want to staff a full team to run it. You need a dependable managed-service partner with real service levels.

## 4. Proposed solution

We will operate and support your application under a defined SLA: 24/7 monitoring and incident response, regular patching, tiered support with a named lead, and a running backlog of enhancements — with transparent service reviews and reporting.
...
- Integration with the application's cloud environment via documented, versioned APIs.
- Integration with monitoring/alerting and ticketing tools via documented, versioned APIs.
...
from comparable **Application Managed Services** engagements, matched by industry and
project type, on request.

## 9. Pricing

We propose a **fixed fee of $300,000** (Monthly retainer by service tier),
within your estimated budget of $120,000 –
$480,000.

| Line item | Amount |
| --- | ---: |
| Discovery & solution design | $40,000 |
| Development & configuration | $125,000 |
| Integrations | $50,000 |
| Data migration & setup | $25,000 |
| Quality assurance & security testing | $30,000 |
| Training, documentation & launch | $20,000 |
| Project management | $10,000 |
| **Total (fixed price)** | **$300,000** |
