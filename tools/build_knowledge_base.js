 ...
 *
 * Content is generated from dist/knowledge-data.json, which is exported from
 ...
 *
 *   node tools/build_knowledge_base.js [outputDir]
 */
...
const DATA = JSON.parse(fs.readFileSync(path.join(REPO, "dist", "knowledge-data.json"), "utf8"));
const OUT = path.resolve(process.argv[2] || path.join(REPO, "knowledge-base"));
