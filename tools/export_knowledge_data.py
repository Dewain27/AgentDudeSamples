...
The catalog in `rfp-automation-kit/rfpkit/catalog_data.py` stays the source of
...
so the Word documents can never disagree with what the skill and samples use.
    ...
    python tools/export_knowledge_data.py            # -> dist/knowledge-data.json
"""
...
def main():
    ...
    out = REPO / "dist" / "knowledge-data.json"
